...
import 'servidores_model.dart';
export 'servidores_model.dart';

class ServidoresWidget extends StatefulWidget {
  ...
  @override
  State<ServidoresWidget> createState() => _ServidoresWidgetState();
}

class _ServidoresWidgetState extends State<ServidoresWidget> {
  late ServidoresModel _model;
