...
class _PaymentWidgetState extends State<PaymentWidget> {
  ...
  void initState() {
    ...
    _model.nameTextFieldTextController3 ??= TextEditingController();
    _model.nameTextFieldFocusNode3 ??= FocusNode();
                                                                        ...
                                                                        children: [
                                                                          wrapWithModel(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              name: 'Alvert Flore',
                                                                              cardNumber: '0156 - 6198 - 5191 - 6519',
                                                                            ),
                                                                          ),
                                                                          InkWell(
                                                                            splashColor:
